...
public class ContainerArmorGenerator extends ContainerBCBase<TileArmorGenerator> {

	public ContainerArmorGenerator(EntityPlayer player, TileArmorGenerator tile) {
		super(player, tile);
