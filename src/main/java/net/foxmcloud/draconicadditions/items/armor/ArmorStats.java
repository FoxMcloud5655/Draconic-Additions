...
public class ArmorStats {
	...
	@ModConfigProperty(category = "Armor Tweaks", name = "Infused Potato - Right Click Transform", comment = "Allows you to set whether the Infused Potato Armor will transform upon right-click.\nNote: The armor will still transform when smacking it against a mob.", autoSync = true)
    public static boolean INFUSED_POTATO_RIGHT_CLICK = true;
	@ModConfigProperty(category = "Armor Tweaks", name = "Infused Potato - Drop Transform", comment = "Allows you to set whether the Infused Potato Armor will transform upon dropping it.\nNote: The armor will still transform when smacking it against a mob.", autoSync = true)
