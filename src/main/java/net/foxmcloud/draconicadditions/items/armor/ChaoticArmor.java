...
public class ChaoticArmor extends DraconicArmor {
    ...
    public ItemConfigFieldRegistry getFields(ItemStack stack, ItemConfigFieldRegistry registry) {
        ...
        if (armorType == CHEST) {
            ...
            registry.register(stack, new IntegerConfigField("armorVFSpeedModifier", 0, 0, 600, "config.field.armorVFSpeedModifier.description", SLIDER).setPrefix("+").setExtension("%")); //TODO: See if this works.
    ...
    public ModelBiped getArmorModel(EntityLivingBase entityLiving, ItemStack itemStack, EntityEquipmentSlot armorSlot, ModelBiped _default) {
        ...
        if (model == null) {
            if (armorType == EntityEquipmentSlot.HEAD) model = new ModelChaoticArmor(0.5F, true, false, false, false);
                ...
                model = new ModelChaoticArmor(1.5F, false, true, false, false);
            else if (armorType == EntityEquipmentSlot.LEGS)
                model = new ModelChaoticArmor(1.5F, false, false, true, false);
