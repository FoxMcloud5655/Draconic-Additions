...
public class EnergyBauble extends BasicBauble implements IEnergyContainerItem {
	...
	/**
	 * Can be overridden! This method is called when inquiring about the max energy
	 * this bauble can store.
	 */
	...
	/**
	 * Can be overridden! This method is called when inquiring about the max energy
	 * this bauble can receive per tick.
	 */
	 ...
	 * can be extracted from this bauble by external sources (dischargers). Defaults
	 * to 0, so if you want other blocks/items to be able to discharge energy,
	 * implement your own method for doing so.
	 */
	@Override
