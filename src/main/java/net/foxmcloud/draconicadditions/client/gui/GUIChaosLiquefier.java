...
public class GUIChaosLiquefier extends ModularGuiContainer<ContainerDATile<TileChaosLiquefier>> {
	private TileChaosLiquefier tile;
	private final String GUITranslation;
	protected GuiToolkit<GUIChaosLiquefier> toolkit;

	public GUIChaosLiquefier(ContainerDATile<TileChaosLiquefier> container, Inventory inv, Component title) {
