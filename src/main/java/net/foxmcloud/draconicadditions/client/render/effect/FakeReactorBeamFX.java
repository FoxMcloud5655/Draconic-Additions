package net.foxmcloud.draconicadditions.client.render.effect;
 ...
 */
public class FakeReactorBeamFX extends Particle {
    ...
    public FakeReactorBeamFX(ClientLevel worldIn, Vec3D pos, Direction facing, TileFakeReactorCore tile, boolean isInjectorEffect) {
