...
public class RecipeGenerator extends RecipeProvider {
	...
	private void blocks() {
		...
		fusionRecipe(DAContent.fakeReactorCore, "blocks")
	        .catalyst(DAContent.hermal)
	        .energy(6400000)
	        ...
	        .ingredient(DETags.Items.INGOTS_DRACONIUM)
	        .ingredient(DETags.Items.INGOTS_DRACONIUM_AWAKENED)
	        .ingredient(DEContent.CHAOS_FRAG_SMALL)
	        .ingredient(DEContent.CHAOS_FRAG_SMALL);

		fusionRecipe(DAContent.fakeReactorInjector, "blocks")
	        .catalyst(DEContent.CORE_DRACONIUM)
	        .energy(1600000)
	        .techLevel(TechLevel.DRACONIC)
	        .ingredient(DETags.Items.INGOTS_DRACONIUM)
        ...
        fusionRecipe(DAContent.fakeReactorStabilizer, "blocks")
