...
import net.foxmcloud.draconicadditions.client.render.item.RenderItemFakeReactorComponent;
...
public class ItemModelGenerator extends ItemModelProvider {
	...
	protected void registerModels() {
		...
		blockItem(DAContent.fakeReactorCore);
		blockItem(DAContent.fakeReactorInjector);
		blockItem(DAContent.fakeReactorStabilizer);
		dummyBlock(DAContent.fakeReactorCore);
		dummyBlock(DAContent.fakeReactorInjector);
		dummyBlock(DAContent.fakeReactorStabilizer);
		clazz(DAContent.itemFakeReactorCore, RenderItemFakeReactorComponent.class);
		clazz(DAContent.itemFakeReactorInjector, RenderItemFakeReactorComponent.class);
		clazz(DAContent.itemFakeReactorStabilizer, RenderItemFakeReactorComponent.class);
